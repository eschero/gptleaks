export default function initRotatingAscii(container, theme) {
  ...
  const logoArt = [
    ...
    '                      .*LEAKSLEAKSLEAKS#-.                    ',
    '                    -LEAKS%+---=#LEAKS+.                      ',
    '                  .#LEAK-..      .:#LEAK%LEAKSLEAKS*-.        ',
    '                 .#LEA*.         .=%LEAKS%LEAKSLEAKS:         ',
    '              .-+#LEA*.       .+%LEAKS+..    ..+LEAKS..       ',
    '          ..*LEAKSLEAKS=     .+LEAKS%+..          .+LEAK:     ',
    '         .*LEAK#-.*LEA=   .LEAK%=.     ..         =LEAK       ',
    '        :LEAK+..  *LEA=   .LE-.     .-#LEAK*:.      LEAK.     ',
    '       .LEAK:.    *LEA=   .L%.  ..=LEAK#-LEAKS#-.  .*LEA-     ',
    '       +LEA*      *LEA=   :L%..+LEAK#.     .*LEAKS-.LEAK.     ',
    '       *LEA=      *LEA=   :LEAKS++LEAK#:.     .*LEAKS+        ',
    '       *LEA+      *LEA=   -LE=     .=LEAK#..     .=LEAK:.     ',
    '       :LEAK.    .+LEAK%.  -L%.       .#L+LEAK%.      :LEA-   ',
    '       .-LEAK:    ..:#LEAK%+L%        #L=..:#LEA+     .LEAK:  ',
    '        .:LEAKS=.  ....:#LEAK=      -LE-...-LE#      +LEA*    ',
    '          +LEAKSLEAK+..     :#LEAKS=LEAK-   -LE#      -LEA#.  ',
    '         .LEAK.-%LEAKS*..   ..#LEAK*:.L@:   -LE#      +LEA+   ',
    '         :LEA#   .-#LEAKS#:LEAK=..  .L@:   -LE#     :LEAK.    ',
    '         .LEA%.     .:#LEAK%=.      -LE:   -LE#   .+LEAK:     ',
    '          #LEA=.       ....   ..-%LEAKS.   -LE#.-#LEAK#..     ',
    '          :LEAK=.           .=%LEAKS+.     -LEAKSLEA*..       ',
    '           .#LEAK+..    ..+LEAKS%+..       *LE#+-..           ',
